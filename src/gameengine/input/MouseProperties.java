...
public interface MouseProperties {
    ...
    /**
     * Sets the mouse sensitivity.  Set to 1 for no effect, less than 1 to slow
     * down, or greater than 1 to speed up.
     *
    ...
    /**
     * Sets the mouse wheel sensitivity.  Set to 1 for no effect.  Greater than
     * 1 to speed up, a fraction to slow down, and negative to reverse direction
     *
    ...
    /**
     * Sets the mouse acceleration.  Set to 0 for no acceleration.  A good value
     * is 0.08.
     *
    ...
    /**
     * Sets the mouse smoothing factor.  A larger smoothing factor smoothes out
     * the mouse movement jumps.  This adds some lag but the mouse starts moving
     * right away towards the destination.  The mouse reaches the destination
     * location (smoothingFactor - 1) frames late.
     *
