...
public class User {
    ...
    private HashMap<Integer, Action> controls = new HashMap<>();
     ...
     *
     * @param inputCode the {@link InputCode} you want the binding removed for
     */
     ...
     *
     * @param inputCode the {@link InputCode} that is mapped to the action
     * @return the {@link Action} mapped to the specified {@link InputCode}
     */
     ...
     *
     * @return a {@link String} of the users name
     */
